...
const DEFAULT_DICTIONARIES: Array<{ group: string; code: string; label: string; order: number }> = [
  ...
  { group: 'transaction_category_expense', code: '购物', label: '购物', order: 1 },
  { group: 'transaction_category_expense', code: '日用百货', label: '日用百货', order: 2 },
  { group: 'transaction_category_expense', code: '交通养车', label: '交通养车', order: 3 },
  { group: 'transaction_category_expense', code: '文化娱乐', label: '文化娱乐', order: 4 },
  { group: 'transaction_category_expense', code: '住房', label: '住房', order: 5 },
  ...
  { group: 'transaction_category_expense', code: '医疗', label: '医疗', order: 9 },
  { group: 'transaction_category_expense', code: '育儿母婴', label: '育儿母婴', order: 10 },
  { group: 'transaction_category_expense', code: '服饰', label: '服饰', order: 11 },
  { group: 'transaction_category_expense', code: '保险', label: '保险', order: 12 },
  { group: 'transaction_category_expense', code: '宠物', label: '宠物', order: 13 },
  ...
  { group: 'transaction_category_transfer', code: '信用借还', label: '信用借还', order: 1 },
  { group: 'transaction_category_transfer', code: '投资理财', label: '投资理财', order: 2 },
