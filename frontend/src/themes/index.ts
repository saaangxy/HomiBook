...
export const themes: Record<string, Theme> = {
  ...
  craft: {
    id: 'craft',
    name: '手工杂货铺',
    description: '牛皮纸纹理、手写体、暖棕色系、缝线装饰',
    mode: 'light',
    fontFamily: '"ZCOOL XiaoWei", "楷体", KaiTi, serif',
    vars: {
      '--background': '36 30% 94%',
      '--foreground': '24 25% 18%',
      '--card': '36 25% 97%',
      '--card-foreground': '24 25% 18%',
      '--popover': '36 25% 97%',
      '--popover-foreground': '24 25% 18%',
      '--primary': '22 65% 42%',
      '--primary-foreground': '36 30% 98%',
      '--secondary': '35 20% 88%',
      '--secondary-foreground': '24 25% 18%',
      '--muted': '35 15% 85%',
      ...
      '--input': '30 15% 80%',
      '--ring': '22 65% 42%',
      '--sidebar-background': '34 25% 90%',
      '--sidebar-foreground': '24 25% 18%',
      '--sidebar-primary': '22 65% 42%',
      '--sidebar-primary-foreground': '36 30% 98%',
      '--sidebar-accent': '35 20% 85%',
      '--sidebar-accent-foreground': '24 25% 18%',
      '--sidebar-border': '30 20% 72%',
      '--sidebar-ring': '22 65% 42%',
    },
  },
